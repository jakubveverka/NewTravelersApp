...
namespace FreeTravelersApp.Pages
{
    public partial class WelcomePage : ContentPage
    {
        ...
        private List<CommandButton> InitializeCommands()
        {
            ...
            {
				new CommandButton() { Icon = "guides.png", Capture = "Prohlídky", Command = () => Navigation.PushAsync(new LocationsPage()) },
				new CommandButton() { Icon = "profile.png", Capture = "Profil", Command = () => Navigation.PushAsync(new ProfilPage()) },
				new CommandButton() { Icon = "help.png", Capture = "Nápověda", Command = () => Navigation.PushAsync(new ConditionsPage()) },
				new CommandButton() { Icon = "guides.png", Capture = "Průvodci", Command = () => Navigation.PushAsync(new UsersListPage()) },
